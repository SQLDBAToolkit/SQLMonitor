    ...
    public class VerticalLabel : System.Windows.Forms.Control
    {
        ...
        protected override void OnPaint(System.Windows.Forms.PaintEventArgs e)
        {
            ...
            if (this.TextDrawMode == DrawMode.BottomUp)
            {
                ...
                e.Graphics.DrawString(labelText, Font, labelForeColorBrush, width, 0, strFormat);
            }
            else
            {
                ...
                e.Graphics.DrawString(labelText, Font, labelForeColorBrush, width, 0, strFormat);  //StringFormat.GenericTypographic);
            }
            //if (this.TextDrawMode == DrawMode.BottomUp)
            //{
            //    vlblTransformX = 0;
